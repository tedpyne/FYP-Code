...
if __name__ == '__main__':
    ...
    parser.add_argument('--scenario', type=str, help="intersection, circularroad, lanechange, twocarlanechange, threecarlanechange", default=SCENARIO_NAME)
    ...
    while not done:
        ...
        print(reward)
        # print(env.ped_1.distanceTo(env.ego))
        # print(env.ego.speed)
