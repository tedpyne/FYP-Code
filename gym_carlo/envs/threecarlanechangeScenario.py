...
class threeCarLanechangeScenario(gym.Env):
    def __init__(self, goal):
        ...
        self.init_c3 = Car(Point(37,80), np.pi/2 , 'blue')
        self.init_c3.velocity = Point(1., 0.)
        self.init_c3.min_speed = 0.
        self.init_c3.max_speed = 10.
    ...
    def reset(self):
        ...
        self.c3 = self.init_c3.copy()
        self.c3.center = Point(42, random.uniform(10, 40))
        self.c3.heading = np.pi/2
        self.c3.velocity = Point(0, random.uniform(7, 9))
    ...
    def ado_rules(self):
        ...
        # Ado vehicle decelerates to a limit when ego vehicle approaches
        if self.ego.center.y - self.c3.center.y < -10 and self.c3.velocity.y > 2:
            self.c3.velocity.y = self.c3.velocity.y - 0.01
            
        # Ado vehicle accelarates after ego vehicle overtakes
        if self.ego.center.y - self.c3.center.y > 10 and self.c3.velocity.y < 3:
            self.c3.velocity.y = self.c3.velocity.y + 0.01
